...
namespace AutoMate_app.Controllers
{
    ...
    public class ServiceTypesController : Controller
    {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            if (serviceType != null)
            {
                // Check if any ServiceRequests use this ServiceType
                var hasRequests = await _context.ServiceRequests
                    .AnyAsync(sr => sr.ServiceTypeId == id);

                if (hasRequests)
                {
                    TempData["Error"] = "Cannot delete this service type because it is being used by service requests.";
